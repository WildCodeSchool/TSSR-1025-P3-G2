...
Pour assurer la reproductibilité et la scalabilité :

- Installation via script officiel iRedMail (une seule exécution)  
- Configuration DNS externalisée (SPF/DKIM/DMARC générés automatiquement)  
- Scripts Ansible / Bash pour :  
  - Déploiement d’agents de monitoring supplémentaires  
  - Ajout automatique de nouveaux domaines   
  - Sauvegardes incrémentielles de `/var/vmail` et MariaDB
