...
- [Installation de l'outils PingCastle sur ECO-BDX-EX02](#installation-de-loutils-pingcastle-sur-eco-bdx-ex02)
  - [Table des matières](#table-des-matières)
  - [1. Désactivation du service Print Spooler sur les DCs](#1-désactivation-du-service-print-spooler-sur-les-dcs)
    - [Description de la faille](#description-de-la-faille)
    - [Correction](#correction)
    - [Etape 1 - Création de la GPO](#etape-1---création-de-la-gpo)
    - [Etape 2 - Configuration de la GPO](#etape-2---configuration-de-la-gpo)
    - [Etape 3 - Security Filtering](#etape-3---security-filtering)
    - [Etape 4 - Application et vérification](#etape-4---application-et-vérification)
    - [Résultat](#résultat)
  - [2. Déploiement de Windows LAPS (GPO)](#2-déploiement-de-windows-laps-gpo)
    - [Description de la faille](#description-de-la-faille-1)
    - [Correction](#correction-1)
    - [Etape 1 - Extension du schéma AD](#etape-1---extension-du-schéma-ad)
    - [Etape 2 - Délégation des permissions sur les OUs](#etape-2---délégation-des-permissions-sur-les-ous)
    - [Etape 3 - Configuration de la GPO LAPS](#etape-3---configuration-de-la-gpo-laps)
    - [Etape 4 - Application et vérification](#etape-4---application-et-vérification-1)
    - [Résultat](#résultat-1)
  - [3. Politique de mot de passe insuffisante (AD AC)](#3-politique-de-mot-de-passe-insuffisante-ad-ac)
    - [Description de la faille](#description-de-la-faille-2)
    - [Correction](#correction-2)
    - [Etape 1 - Création de la PSO via l'ADAC](#etape-1---création-de-la-pso-via-ladac)
    - [Etape 2 - Configuration des paramètres](#etape-2---configuration-des-paramètres)
    - [Etape 3 - Application aux groupes](#etape-3---application-aux-groupes)
    - [Etape 4 - Vérification](#etape-4---vérification)
    - [Résultat](#résultat-2)
  - [4. Comptes administrateurs sensibles et non délégables (GUI)](#4-comptes-administrateurs-sensibles-et-non-délégables-gui)
    - [Description de la faille](#description-de-la-faille-3)
    - [Correction](#correction-3)
    - [Résultat](#résultat-3)
  - [5. Groupe Schema Admins non vide (GUI)](#5-groupe-schema-admins-non-vide-gui)
    - [Description de la faille](#description-de-la-faille-4)
    - [Correction](#correction-4)
    - [Résultat](#résultat-4)
  - [6. Désactivation des protocoles NTLMv1 et LM (GPO)](#6-désactivation-des-protocoles-ntlmv1-et-lm-gpo)
    - [Description de la faille](#description-de-la-faille-5)
  ...
  - [7. Restriction de l'enregistrement des ordinateurs dans le domaine (PowerShell)](#7-restriction-de-lenregistrement-des-ordinateurs-dans-le-domaine-powershell)
    - [Description de la faille](#description-de-la-faille-6)
