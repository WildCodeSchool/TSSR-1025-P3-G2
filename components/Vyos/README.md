...
# 2. Documentation Technique - Routeur Cœur L3 (AX01)
...
| :---: | :---: | :--- | :--- | :---: | :--- |
| **200** | 200 | MGMT (ESXi) | `10.20.0.0` | /28 | `10.20.0.4`* |
| **210** | 210 | DSI / ADMIN | `10.20.10.0` | /28 | `10.20.10.254` |
| **220** | 220 | SERVEURS | `10.20.20.0` | /27 | `10.20.20.254` |
